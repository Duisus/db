...
namespace ConsoleApp
{
    class Program
    {
        ...
        private Program(string[] args)
        {
            ...
            var db = mongoClient.GetDatabase("GameRSP");
        ...
        private bool HandleOneGameTurn(Guid humanUserId)
        {
            ...
            {
                // Сохранить информацию о прошедшем туре в IGameTurnRepository. Сформировать информацию о закончившемся туре внутри FinishTurn и вернуть её сюда.
        ...
        private void ShowScore(GameEntity game)
        {
            ...
            var turns = turnRepo.GetLastTurns(game.Id);
